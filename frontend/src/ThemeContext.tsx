...
const themeVariables: Record<ThemeName, Record<string, string>> = {
  light: {
    ...
    '--color-scrollbar-track': 'rgba(148, 163, 184, 0.15)',
    '--color-scrollbar-thumb': 'rgba(56, 189, 248, 0.4)',
    '--color-scrollbar-thumb-hover': 'rgba(56, 189, 248, 0.55)',
  ...
  dark: {
    ...
    '--color-scrollbar-track': 'rgba(100, 116, 139, 0.18)',
    '--color-scrollbar-thumb': 'rgba(56, 189, 248, 0.45)',
    '--color-scrollbar-thumb-hover': 'rgba(56, 189, 248, 0.62)',
